...
.. image:: /user_guide/img/sales/price_lists/PriceListsCurrencies.png
...
However, you may select a different currency with a currency picker in the upper-right corner of the page.
...
.. image:: /user_guide/img/sales/price_lists/price_currency_change2.png
   :class: with-border

**Sample: Prices in Euro are Missing**

.. image:: /user_guide/img/sales/price_lists/price_currency_change_no_price_in_selected_currency.png
   :class: with-border
