...
.. image:: /user_guide/img/business_intelligence/lead_statistics_1.png
...
.. image:: /user_guide/img/business_intelligence/lead_statistics_2.png

Related Articles
^^^^^^^^^^^^^^^^

* `How to Create and Work with a Lead <https://www.oroinc.com/doc/orocrm/current/user-guide-sales-tools/b2b-sales/leads#user-guide-system-channel-entities-leads>`_
