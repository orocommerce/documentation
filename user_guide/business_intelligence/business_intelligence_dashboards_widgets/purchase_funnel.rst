.. _user-guide--business-intelligence--widgets--purchase-funnel:
...
.. image:: /user_guide/img/business_intelligence/purchase_funnel.png
...
.. image:: /user_guide/img/business_intelligence/purchase_funnel_config.png


Related Articles
^^^^^^^^^^^^^^^^

* `Tracking Websites <https://www.oroinc.com/doc/orocrm/current/user-guide-marketing-tools/tracking#user-guide-marketing-tracking>`_