...
Category node is a direct link to the product category with the list of products in OroCommerce Storefront.

To add a category node to the menu on the OroCommerce Storefront:
