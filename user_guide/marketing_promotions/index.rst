...
* Manage discounts in placed :ref:`orders <user-guide--sales--orders>` and view them in :ref:`shopping lists <frontstore-guide--shopping-lists>` in the management console.
