...
Use `oro:api:doc:cache:clear <./commands.md#oroapidoccacheclear>`__ command to apply changes in ``ApiDoc`` annotation to `API Sandbox <https://www.oroinc.com/doc/orocommerce/current/dev_guide/web_api/index#api-sandbox>`__.
