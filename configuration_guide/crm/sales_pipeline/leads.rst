...
More information on leads can be found in the relevant `Leads topic <https://www.oroinc.com/doc/orocrm/current/user-guide-sales-tools/b2b-sales/leads#user-guide-system-channel-entities-leads>`_ in OroCRM documentation.